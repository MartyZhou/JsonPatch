...
{
    [JsonConverter(typeof(TypedJsonPatchDocumentNewConverter))]
    public class JsonPatchDocumentNew<TModel> : IJsonPatchDocumentNew where TModel : class
    {
        public List<OperationNew<TModel>> Operations { get; private set; }
        ...
        {
            Operations = new List<OperationNew<TModel>>();
            ContractResolver = new DefaultContractResolver();
        }

        // Create from list of operations
        public JsonPatchDocumentNew(List<OperationNew<TModel>> operations, IContractResolver contractResolver)
        {
        ...
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Add<TProp>(Expression<Func<TModel, TProp>> path, TProp value)
        {
            if (path == null)
            {
            ...
            Operations.Add(new OperationNew<TModel>(
                "add",
                GetPath(path, null),
                from: null,
                value: value));
        ...
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Add<TProp>(
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Add<TProp>(Expression<Func<TModel, IList<TProp>>> path, TProp value)
        {
            if (path == null)
            {
                throw new ArgumentNullException(nameof(path));
        ...
        /// <param name="path">target location</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Remove<TProp>(Expression<Func<TModel, TProp>> path)
        {
            if (path == null)
            {
                throw new ArgumentNullException(nameof(path));
            ...
            Operations.Add(new OperationNew<TModel>("remove", GetPath(path, null), from: null));
        ...
        /// <param name="position">position</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Remove<TProp>(Expression<Func<TModel, IList<TProp>>> path, int position)
        {
            if (path == null)
            {
                throw new ArgumentNullException(nameof(path));
        ...
        /// <param name="path">target location</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Remove<TProp>(Expression<Func<TModel, IList<TProp>>> path)
        {
            if (path == null)
            {
                throw new ArgumentNullException(nameof(path));
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Replace<TProp>(Expression<Func<TModel, TProp>> path, TProp value)
        {
            if (path == null)
            {
                throw new ArgumentNullException(nameof(path));
        ...
        /// <param name="position">position</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Replace<TProp>(Expression<Func<TModel, IList<TProp>>> path,
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Replace<TProp>(Expression<Func<TModel, IList<TProp>>> path, TProp value)
        {
            if (path == null)
            {
                throw new ArgumentNullException(nameof(path));
        ...
        /// <param name="path">target location</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Move<TProp>(
        ...
        /// <param name="path">target location</param>
        /// <returns></returns>
        public JsonPatchDocumentNew<TModel> Copy<TProp>(
           Expression<Func<TModel, TProp>> from,
           Expression<Func<TModel, TProp>> path)
        {
            if (from == null)
        ...
        public void ApplyTo(TModel objectToApplyTo, IObjectAdapterNew adapter)
        {
            if (objectToApplyTo == null)
            {
                throw new ArgumentNullException(nameof(objectToApplyTo));
