...
{
    public class ObjectAdapterNew : IObjectAdapterNew
    {
        /// <summary>
        ...
        public void Add(OperationNew operation, object objectToApplyTo)
        {
            if (operation == null)
            {
        ...
        /// <param name="objectToApplyTo">Object to apply the operation to.</param>
        public void Move(OperationNew operation, object objectToApplyTo)
        {
            if (operation == null)
            {
                throw new ArgumentNullException(nameof(operation));
        ...
        /// <param name="objectToApplyTo">Object to apply the operation to.</param>
        public void Remove(OperationNew operation, object objectToApplyTo)
        {
            if (operation == null)
            {
                throw new ArgumentNullException(nameof(operation));
        ...
        /// </summary>
        private void Remove(string path, object objectToApplyTo, OperationNew operationToReport)
        {
            var parsedPath = new ParsedPath(path);
            var visitor = new ObjectVisitor(parsedPath, ContractResolver);
        ...
        /// <param name="objectToApplyTo">Object to apply the operation to.</param>
        public void Replace(OperationNew operation, object objectToApplyTo)
        {
            if (operation == null)
            {
                throw new ArgumentNullException(nameof(operation));
        ...
        /// <param name="objectToApplyTo">Object to apply the operation to.</param>
        public void Copy(OperationNew operation, object objectToApplyTo)
        {
            if (operation == null)
            {
                throw new ArgumentNullException(nameof(operation));
        ...
        private JsonPatchError CreateOperationFailedError(object target, string path, OperationNew operation, string errorMessage)
        {
        ...
        private JsonPatchError CreatePathNotFoundError(object target, string path, OperationNew operation, string errorMessage)
        {
            return new JsonPatchError(
                target,
                operation,
