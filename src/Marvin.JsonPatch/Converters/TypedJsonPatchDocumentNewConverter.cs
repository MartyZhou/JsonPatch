...
{
    public class TypedJsonPatchDocumentNewConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            try
            {
                ...
                var genericOperation = typeof(OperationNew<>);
            ...
            catch (Exception ex)
            {
                throw new JsonPatchException(
                    new JsonPatchError(null, null, "The JsonPatchDocumentNew was malformed and could not be parsed."), ex, 400);
            }
        }
